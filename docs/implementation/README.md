...
| 6 Interaction/Notification | In progress | Project team | Notification Go API/migration, PostgreSQL inbox/templates/deliveries/attempts/suppression, Account/Booking RabbitMQ consumer, retry worker, development sink, AsyncAPI, unit/component harness, Compose/runbook | Approved provider/contact resolution, channel/preference/reveal policy, remaining recipient projections, failure/production evidence |

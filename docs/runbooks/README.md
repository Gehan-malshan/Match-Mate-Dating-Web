...
- [`notification-local.md`](notification-local.md) — start, smoke-test, and diagnose the first Notification consumer/delivery slice without exposing recipient contact data.
